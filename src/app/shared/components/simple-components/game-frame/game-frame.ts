...
@Component({
  ...
  template: `
    <div [class]="bgClass + ' ' + borderClass"
         class="relative border-4 rounded-xl p-4 sm:p-6 shadow-[0_0_20px_rgba(0,0,0,0.5)] backdrop-blur-sm w-full max-w-3xl flex flex-col md:flex-row items-center gap-4 sm:gap-8">
